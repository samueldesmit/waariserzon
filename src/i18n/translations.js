export const translations = {
  en: {
    ...
    hereButCloudyKicker: 'No sun here right now',
    ...
    geoDeniedHint: 'Check your browser\'s site permissions for this page and allow location access, then reload.',
    geoDeniedHintIOS: 'On iPhone or iPad: open Settings → Safari → Location and set it to "Allow". Then reload the page.',
    geoDeniedHintAndroid: 'On Android: tap the lock icon next to the address bar, open "Permissions", and allow location. Then reload the page.',
    geoDeniedHintDesktop: 'Click the lock (or info) icon next to the address bar, allow location for this site, and reload the page.',
  ...
  nl: {
    ...
    searchNoResults: 'Geen plaatsen gevonden',
    ...
    hereButCloudyKicker: 'Geen zon waar je bent',
    ...
    geoDeniedHint: 'Controleer de site-rechten van je browser en sta locatie toe voor deze pagina. Herlaad daarna de pagina.',
    geoDeniedHintIOS: 'Op iPhone of iPad: ga naar Instellingen → Safari → Locatie en zet het op "Sta toe". Herlaad daarna de pagina.',
    geoDeniedHintAndroid: 'Op Android: tik op het slotje naast de adresbalk, open "Rechten" en sta locatie toe. Herlaad daarna de pagina.',
    geoDeniedHintDesktop: 'Klik op het slotje (of info-icoon) naast de adresbalk, sta locatie toe voor deze site en herlaad de pagina.',
